...
public class CreateProjectRiskReserveResp {
...
private List<ProjectRiskReserveHistory> projectRiskReserveHistories = null;
...
@JsonProperty("RisksJson")
public Object getRisksJson() {
return risksJson;
}

@JsonProperty("RisksJson")
public void setRisksJson(Object risksJson) {
...
@JsonProperty("IssuesJson")
public Object getIssuesJson() {
return issuesJson;
}

@JsonProperty("IssuesJson")
public void setIssuesJson(Object issuesJson) {
...
@JsonProperty("ProjectRiskReserveHistories")
public List<ProjectRiskReserveHistory> getProjectRiskReserveHistories() {
return projectRiskReserveHistories;
}

@JsonProperty("ProjectRiskReserveHistories")
public void setProjectRiskReserveHistories(List<ProjectRiskReserveHistory> projectRiskReserveHistories) {
